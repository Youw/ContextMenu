...
FiacsContextMenuHlr::FiacsContextMenuHlr(void) : m_cRef(1), 
...
FiacsContextMenuHlr::~FiacsContextMenuHlr(void)
{
    if (m_hMenuBmp)
    {
...
void FiacsContextMenuHlr::OnMakeLogOfChecksums(HWND hWnd)
{
...
IFACEMETHODIMP FiacsContextMenuHlr::QueryInterface(REFIID riid, void **ppv)
{
    static const QITAB qit[] = 
    {
        QITABENT(FiacsContextMenuHlr, IContextMenu),
        QITABENT(FiacsContextMenuHlr, IShellExtInit), 
        { 0 },
    };
...
IFACEMETHODIMP_(ULONG) FiacsContextMenuHlr::AddRef()
{
    return InterlockedIncrement(&m_cRef);
}

// Decrease the reference count for an interface on an object.
IFACEMETHODIMP_(ULONG) FiacsContextMenuHlr::Release()
{
...
IFACEMETHODIMP FiacsContextMenuHlr::Initialize(
...
//
IFACEMETHODIMP FiacsContextMenuHlr::QueryContextMenu(
...
//
IFACEMETHODIMP FiacsContextMenuHlr::InvokeCommand(LPCMINVOKECOMMANDINFO pici)
{
    BOOL fUnicode = FALSE;
...
//            since Windows 2000.
//
IFACEMETHODIMP FiacsContextMenuHlr::GetCommandString(UINT_PTR idCommand, 
